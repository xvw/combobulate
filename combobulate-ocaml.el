...
(defun combobulate-ocaml-imenu-node-p (node) "Return t if NODE is a valid imenu node for OCaml." 
  (member 
    (treesit-node-type node) '("type_definition" "exception_definition" "external" "value_definition" "method_definition" "instance_variable_definition" "module_definition" "module_type_definition" "class_definition" "class_type_definition" "include_module" "include_module_type" "open_module" "value_specification"))) 

(defun combobulate-ocaml-imenu-name-function (node) "Return the name of the imenu entry for NODE in OCaml." 
  (or 
    (pcase 
...
;; For value definitions (let bindings), get the pattern name
      ...
      ("value_definition" 
        (when-let* 
          (
            (let-binding 
              (treesit-search-subtree node "let_binding")) 
            (pattern 
              (treesit-node-child-by-field-name let-binding "pattern")) 
            (name-node 
              (or 
                (treesit-search-subtree pattern "value_name") 
...
;; For type definitions, get the type name
      ...
      ("type_definition" 
        (when-let* 
          (
            (type-binding 
              (treesit-search-subtree node "type_binding")) 
            (name-node 
              (treesit-search-subtree type-binding "type_constructor"))) 
          (concat "type " 
            (treesit-node-text name-node t)))) 
;; For module definitions, get the module name
      ...
      ("module_definition" 
        (when-let* 
          (
            (module-binding 
              (treesit-search-subtree node "module_binding")) 
            (name-node 
              (treesit-search-subtree module-binding "module_name"))) 
          (concat "module " 
            (treesit-node-text name-node t)))) 
;; For class definitions, get the class name
      ...
      ("class_definition" 
        (when-let* 
          (
            (class-binding 
              (treesit-search-subtree node "class_binding")) 
            (name-node 
              (treesit-search-subtree class-binding "class_name"))) 
          (concat "class " 
            (treesit-node-text name-node t)))) 
;; For exception definitions, get the exception name
      ...
      ("exception_definition" 
        (when-let 
          (
            (name-node 
              (treesit-search-subtree node "constructor_name"))) 
          (concat "exception " 
            (treesit-node-text name-node t)))) 
...
;; For module type definitions
      ...
      ("module_type_definition" 
        (when-let 
          (
            (name-node 
              (treesit-search-subtree node "module_type_name"))) 
          (concat "module type " 
            (treesit-node-text name-node t)))) 
...
;; For method definitions
      ...
      ("method_definition" 
        (when-let 
          (
            (name-node 
              (treesit-search-subtree node "method_name"))) 
          (concat "method " 
            (treesit-node-text name-node t)))) 
;; For class type definitions
      ...
      ("class_type_definition" 
        (when-let* 
          (
            (class-type-binding 
              (treesit-search-subtree node "class_type_binding")) 
            (name-node 
              (treesit-search-subtree class-type-binding "class_type_name"))) 
          (concat "class type " 
            (treesit-node-text name-node t)))) 
;; For include_module
      ...
      ("include_module" 
        (when-let 
          ...
          (concat "include " 
            (treesit-node-text module-node t)))) 
;; For include_module_type
      ...
      ("include_module_type" 
        (when-let 
          (
            (sig-node 
              (treesit-search-subtree node "signature"))) "include <sig>"))) 
...
;; e.g. constant values, identifiers and type identifiers
 '(
    (context-nodes '("false" "true" "number" "class_name" "value_name" "module_name" "module_type_name" "field_name" "false" "true")) 
...
(procedures-defun '(
  (:activation-nodes 
    (
      (:nodes 
        ( "type_definition" "exception_definition" "external" "value_definition" "method_definition" "instance_variable_definition" "module_definition" "module_type_definition" "class_definition")))))) 
...
;; ask Combobulate to give you all the node types that can appear in it:
  ...
  (:activation-nodes 
    (
      (:nodes 
        ("signature" "structure" "module_name" "module_path" "module_type_constraint") :has-ancestor 
        ("module_definition" "module_type_definition" "package_expression")) 
      (:nodes 
        ( "attribute" "field_declaration" "function_expression" 
          ...
          (rule "class_binding") 
          (rule "class_application") (rule "type_binding") 
          (rule "method_definition") (rule "structure") (rule "signature") (irule "signature") (irule "structure") 
          (rule "_class_field_specification") 
          (rule "_sequence_expression") 
          (rule "_signature_item") 
          (rule "_structure_item")) )) :selector 
    (:choose node :match-siblings t)) 
  (:activation-nodes 
    (
      (:nodes 
        ( 
          (rule "compilation_unit")))) :selector 
    (:choose node :match-children t)) )) 
    ...
    (
      (:nodes 
        ("object_expression" 
          ...
          (rule "object_expression") 
          (rule "class_binding")))) :selector 
    (:choose node :match-children 
      (:discard-rules ("tag_specification")))) 
  (:activation-nodes 
    ( 
      (:nodes 
        ("signature" "structure" "module_name" "module_path") :has-ancestor 
        ("module_definition" "module_type_definition" "package_expression")) 
      (:nodes 
        ( 
...
;; Removed class_application to avoid conflict with class_binding rule above
 (rule "type_binding") 
          (rule "method_definition") (irule "value_path") (irule "signature") (irule "structure") 
          (rule "_signature_item") 
          (rule "_structure_item")) )) :selector 
    (:choose node :match-children t)) 
...
(defconst combobulate-ocaml-interface-definitions '(
  (context-nodes '("false" "true" "number" "class_name" "value_name" "module_name" "module_type_name" "field_name" 
...
(procedures-defun '(
  (:activation-nodes 
    (
      (:nodes 
        ( "type_definition" "exception_definition" "value_specification" ; val declarations
 "module_definition" "module_type_definition" "class_definition" "class_type_definition" ; class type specs
 "include_module" "include_module_type" "open_module")))))) 
...
(procedures-sibling '( 
  (:activation-nodes 
    (
      (:nodes 
        ( "variant_declaration" "record_declaration"))) :selector 
    (:choose node :match-children t)) 
  (:activation-nodes 
    (
      (:nodes 
...
;; Other nodes
 "attribute" "field_declaration" 
          ...
          (rule "object_expression") 
          (rule "constructor_declaration") 
          (rule "class_binding") (rule "type_binding") (rule "signature") (irule "signature") 
          (rule "_class_field_specification")))) :selector 
    (:choose node :match-siblings t)) 
  (:activation-nodes 
    (
      (:nodes 
    ...
    (
      (:nodes 
        ( 
          ...
          (rule "object_expression") 
          (rule "constructor_declaration") 
          (rule "class_binding") "class_body_type" "method_specification" (rule "type_binding") (rule "signature") (irule "signature") 
          (rule "_signature_item")) )) :selector 
    (:choose node :match-children t)) 
  (:activation-nodes 
    (
      (:nodes 
...
(define-combobulate-language :name ocaml :language ocaml :major-modes (tuareg-mode) :custom combobulate-ocaml-definitions :setup-fn combobulate-ocaml-setup) 

(define-combobulate-language :name ocaml-interface :language ocaml_interface :major-modes (tuareg-mode) :custom combobulate-ocaml-interface-definitions :setup-fn combobulate-ocaml-setup) 

(defun combobulate-ocaml-setup (_) "Setup function for OCaml mode with Combobulate." 
